...
//Создайте массив ar2 содержащий строки, числа, булевы значения. Выведите его в div.out-2. Используйте шаблон вывода из кода в JS. Вывод - по нажатию кнопки b-2
 ...
 let ar2 = [100, 555, 'Ekat', 'Rome', true, false]
...
let ar3 =  [100, 555, 'Ekat', 'Rome', true, false]
...
let ar4 =  [85,2,3,4,12,35,5,6,7,8,9,10]

function f4() {
    let a = ar4[0];
    let b = ar4[3];
    let c = ar4[8];
    document.querySelector('.out-4').innerHTML = `${a} ${b} ${c}`;
    //document.querySelector('.out-4').innerHTML = ar4.slice(0,5).join(' ')
}
...
let ar6 = ['Marat', 'twin', '20 june', 1985]
let out = '';
function f6() {
...
function f10() {
  let out = ar10[0] + ar10[ar10.length - 1];
